...
// No real accounts exist in this app (see lib/onboarding.ts) — "logging
// out" means clearing this device's local identity so it bounces back to
// onboarding, ready for a fresh profile. Removing ONBOARDING_STORAGE_KEY
// alone is what OnboardingGate actually keys off of; favorites and the
// Fantasy lineup are cleared too since they're personal to whoever just set
// them up, not something a next person on this device should inherit.
